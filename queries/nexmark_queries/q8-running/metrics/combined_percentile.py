...
fp_1 = open(f"./results/q8r/{protocol_1}-99p.csv", "r")
fp_2 = open(f"./results/q8r/{protocol_2}-99p.csv", "r")
fp_3 = open(f"./results/q8r/{protocol_3}-99p.csv", "r")
fp_4 = open(f"./results/q8r/{protocol_4}-99p.csv", "r")
...
ax.set_title("NexMark Q8 - 99th percentile")
plt.tight_layout()
# plt.show()
plt.savefig('results/q8r/figures/combined-99th.pdf')