...
input_msgs = pd.read_csv(f'./results/q12r/{protocol}-input.csv')
output_msgs = pd.read_csv(f'./results/q12r/{protocol}-output.csv')
...
with open(f"./results/q12r/{protocol}-99p.csv", "w") as fp:
