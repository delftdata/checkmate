...
fp_1 = open(f"./results/q1/{protocol_1}-99p.csv", "r")
fp_2 = open(f"./results/q1/{protocol_2}-99p.csv", "r")
fp_3 = open(f"./results/q1/{protocol_3}-99p.csv", "r")
fp_4 = open(f"./results/q1/{protocol_4}-99p.csv", "r")
...
plt.tight_layout()
# plt.show()
plt.savefig('results/q1/figures/combined-99th.pdf')