...
input_msgs = pd.read_csv(f'./results/q8r/{protocol}-input.csv')
output_msgs = pd.read_csv(f'./results/q8r/{protocol}-output.csv')
...
with open(f"./results/q8r/{protocol}-99p.csv", "w") as fp:
...
# plt.tight_layout()
# # plt.show()
# plt.savefig(f'results/q8r/figures/{protocol}')
